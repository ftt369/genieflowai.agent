    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <header className="container mx-auto px-4 py-6 flex justify-between items-center">
        ...
        <div className="flex space-x-4">
          <a href="/auth/signin" className="px-4 py-2 rounded-md border border-gray-600 hover:bg-gray-700 transition-colors">
            Sign In
          </a>
          <a href="/auth/signup" className="px-4 py-2 bg-primary-500 rounded-md hover:bg-primary-600 transition-colors">
            Sign Up
          </a>
        </div>
      </header>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-gradient-to-r from-primary-500/20 to-blue-500/20 rounded-2xl p-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a href="/auth/signup" className="px-8 py-4 bg-primary-500 rounded-lg font-semibold hover:bg-primary-600 transition-colors">
                Start Free Trial
              </a>
              <a href="/contact" className="px-8 py-4 border border-gray-600 rounded-lg hover:bg-gray-700 transition-colors">
                Contact Sales
              </a>
            </div>
